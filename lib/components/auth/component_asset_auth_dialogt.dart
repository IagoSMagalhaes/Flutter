...
class _AuthDialogState extends State<AuthDialog> {
  ...
  ElevatedButton buildButtonConfirm() => ElevatedButton(onPressed: () {
    widget.onConfirm(_passwordController.text);
    Navigator.pop(context);
    }, child: Text("Confirmar"),);

  ElevatedButton buildButtonCancel() => ElevatedButton(onPressed: () => Navigator.pop(context), child: Text("Cancelar"),);
}
